...
<body>
  ...
  <form method="post" class="login" action="<%=request.getContextPath() %>/UserLogin">
    <h1>User Login</h1>
    <input type="text" name="name" class="login-input" required="yes" placeholder="User id" autofocus>
    <input type="password" name="pass" class="login-input" placeholder="Password">
    <input type="submit" value="Login" class="login-submit">
    <p class="login-help"><a href="index.jsp">Admin Login</a></p>
  </form>
