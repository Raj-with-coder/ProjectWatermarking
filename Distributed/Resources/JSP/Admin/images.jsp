...
<div align="left">
	...
	<input type="submit" name="submit" value="Allocate" class="gradientbuttons"/>&nbsp;&nbsp;&nbsp;&nbsp;
		...
		{%>
			<tr>
				<td><input name="chk" type="checkbox" value="<%=rs.getInt(1) %>"><%=count++ %></td>
						<td><img src="<%=request.getContextPath()%>/Resources/Images/Input_Images/<%=rs.getString(2) %>"  height="50" width="50"></img></td>
...
<%
	...
	{%>
		<form id="login" action="<%=request.getContextPath() %>/AddImage" enctype="multipart/form-data" method="post">
