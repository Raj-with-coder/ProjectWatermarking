		...
		try
		{
			...
			if(no==1)
			{
				...
				if(rs.next())
				{
					...
					RequestDispatcher rd=request.getRequestDispatcher("/Resources/JSP/Admin/editprof.jsp?no=0");
					rd.forward(request, response);
				}
				else
					response.sendRedirect(request.getContextPath()+"/Resources/JSP/Admin/editprof.jsp?no=1");
