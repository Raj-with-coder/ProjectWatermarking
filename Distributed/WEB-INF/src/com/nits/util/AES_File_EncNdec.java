...
/* File Decryption (Starts) */
	...
	public static String decryptFile(String inFilePath,String outFilePath,String password) throws Exception
	{
		//String password="password12345678";//Password Must Be Of 16 Characters
		//String password="b9du00q2gaa31lk5";//Password Must Be Of 16 Characters
		try 
...
/* File Decryption (Ends) */
	...
	public static void main(String[] args)
	{
		...
		String inFilePath="1441BMW_logo.jpg";
		String outFilePath="enc_Logo.jpg"; 
		...
		try 
		{
			...
			String encFilePath="enc_Logo.jpg";
			String decFilePath="dec_Logo.jpg"; 
